              ...
              <?php } ?>
							<form action="<?php echo base_url(); ?>loginMe" method="post">
								<div class="form-group form-focus">
									...
									<input class="form-control floating" type="text"  name="email" id="email" required>
								</div>
								<div class="form-group form-focus">
									<label class="control-label">Password</label>
									<input class="form-control floating" type="password"  name="password" id="password" required>
								</div>
								<div class="form-group text-center">
									<input class="btn btn-primary btn-block account-btn" type="submit" value="Login">
								</div>
